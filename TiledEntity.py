...
class TiledEntity(py.sprite.Sprite):
    ...
    def import_images(self, y : int = 0) -> list:
        """
        Méthode utilisée pour charger toutes les images de la TiledEntity, qui les enregistre dans une liste
        "image_list et retourne la liste une fois la boucle finie"
        """
        images_list = []
